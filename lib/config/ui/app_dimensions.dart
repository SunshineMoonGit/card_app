...
class Dimensions {
  ...
  static final kBottomNavBarMargin = const EdgeInsets.symmetric(horizontal: 50.0, vertical: 20.0).w;

  static final kPaddingHorizontalLarge = const EdgeInsets.symmetric(horizontal: 20.0).w;

  static final kPaddingHorizontalMedium = const EdgeInsets.symmetric(horizontal: 16.0).w;

  static final kPaddingHorizontalSmall = const EdgeInsets.symmetric(horizontal: 10.0).w;

  static final kPaddingVerticalLarge = const EdgeInsets.symmetric(vertical: 20.0).w;
